<%@ Page Title="Soporte" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="Soporte.aspx.cs" Inherits="SAG.View.Inicio.Soporte" %>
    ...
    <script>
        ...
        app.controller('SoporteController', function ($scope, $window) {
            $scope.registrarUsuario = function () {
                try {
                    $window.location.href = '/View/Inicio/RegistrarUsuario.aspx';
