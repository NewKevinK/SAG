<%@ Page Title="Registrar Usuario" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="RegistrarUsuario.aspx.cs" Inherits="SAG.app.Inicio.RegistrarUsuario" %>
    ...
    app.controller('RegistrarUsuarioController', function ($scope, $http, $window) {
        ...
        $scope.Registrar = function () {
            ...
            try {
                ...
                $http({
                    method: 'POST',
                    url: '/app/Inicio/RegistrarUsuario.aspx/RegistrarUsuar',
                    data: mydata,
                    ...
                    if (resultado.Result == 1) {
                        ...
                        $('#resultadoModal').on('hidden.bs.modal', function () {
                            $window.location.href = '/app/Inicio/Soporte.aspx';
                        });
                        $('#resultadoModal').modal('show');
