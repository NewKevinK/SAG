<%@ Page Title="Consultar Pacientes" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ConsultarPacientes.aspx.cs" Inherits="SAG.app.Pacientes.ConsultarPacientes" %>
        ...
        app.controller('ConsultarController', function ($scope, $http, $timeout, $window, $location) {
            ...
            var dataTableOptions = {
                ...
                try {
                    $http({
                        method: 'POST',
                        url: '/app/Pacientes/ConsultarPacientes.aspx/ConsultarPacientesSAG',
                        data: mydata,
            ...
            $scope.editarPaciente = function (idPaciente) {
                ...
                var url = $location.protocol() + '://' + $location.host() + ':' + $location.port() + '/app/Pacientes/ModificarPaciente?id=' + idPaciente;
