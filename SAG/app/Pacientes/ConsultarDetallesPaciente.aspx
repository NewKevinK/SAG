<%@ Page Title="Consultar Detalles Paciente" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="ConsultarDetallesPaciente.aspx.cs" Inherits="SAG.app.Pacientes.ConsultarDetallesPaciente" %>
...
<script>
    ...
    app.controller('ConsultarDetallesController', function ($scope, $http, $timeout, $window, $location) {
        ...
        $scope.ModificarPaciente = function (idPaciente) {
            window.location.href = "/app/Pacientes/ModificarPaciente?id=" + idPaciente;
        };
        ...
        $scope.registrarDiagnostico = function () {
            ...
            $http({
                method: 'POST',
                url: '/app/Pacientes/ConsultarDetallesPaciente.aspx/InsertarDiagnostico',
        ...
        $scope.registrarAlergia = function () {
            ...
            $http({
                method: 'POST',
                url: '/app/Pacientes/ConsultarDetallesPaciente.aspx/InsertarAlergia',
                data: alergiaData,
                headers: { 'Content-Type': 'application/json; charset=utf-8' },
                dataType: 'json'
            }).then(function (response) {
        ...
        $scope.registrarServicio = function () {
            ...
            $http({
                method: 'POST',
                url: '/app/Pacientes/ConsultarDetallesPaciente.aspx/InsertarServicio',
                data: datosServicio,
                headers: { 'Content-Type': 'application/json; charset=utf-8' },
                dataType: 'json'
            }).then(function (response) {
        ...
        $scope.guardarInformacionPaciente = function () {
            ...
            $http({
                method: 'POST',
                url: '/app/Pacientes/ConsultarDetallesPaciente.aspx/UpdateDetallesInformacionPaciente',
                data: pacienteInfo,
                headers: { 'Content-Type': 'application/json; charset=utf-8' }
            }).then(function (response) {
                var resultado = response.data.d;
        ...
        try {
            $http({
                method: 'POST',
                url: '/app/Pacientes/ConsultarDetallesPaciente.aspx/GetDetallesPaciente',
                data: mydata,
                headers: { 'Content-Type': 'application/json; charset=utf-8' },
                dataType: 'json'
            }).then(function (response) {
        ...
        try {
            $http({
                method: 'POST',
                url: '/app/Pacientes/ConsultarDetallesPaciente.aspx/GetInformacionPaciente',
                data: mydata,
                headers: { 'Content-Type': 'application/json; charset=utf-8' },
                dataType: 'json'
            }).then(function (response) {
        ...
        try {
            $http({
                method: 'POST',
                url: '/app/Pacientes/ConsultarDetallesPaciente.aspx/GetInformacionPacienteServicio',
                data: mydata,
                headers: { 'Content-Type': 'application/json; charset=utf-8' },
                dataType: 'json'
            }).then(function (response) {
        ...
        try {
            $http({
                method: 'POST',
                url: '/app/Pacientes/ConsultarDetallesPaciente.aspx/GetDiagnosticosPaciente',
                data: mydata,
                headers: { 'Content-Type': 'application/json; charset=utf-8' },
                dataType: 'json'
            }).then(function (response) {
        ...
        $scope.obtenerAlergiasPaciente = function () {
            try {
                $http({
                    method: 'POST',
                    url: '/app/Pacientes/ConsultarDetallesPaciente.aspx/GetAlergiasPaciente',
                    data: mydata,
                    headers: { 'Content-Type': 'application/json; charset=utf-8' },
                    dataType: 'json'
                }).then(function (response) {
