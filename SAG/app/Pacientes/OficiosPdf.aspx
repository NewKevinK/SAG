<%@ Page Title="Generar Oficios"  Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="OficiosPdf.aspx.cs" Inherits="SAG.app.Pacientes.OficiosPdf" %>
        ...
        $scope.generarReportePDF = function () {
            ...
            if ($scope.tipoReporte == undefined) {
                ...
                switch ($scope.tipoReporte) {
                    case "1":
                        url = '/app/Pacientes/OficiosPdf.aspx/GetOficioListaPacientesHopitalizados';
                        break;
                    case "2":
                        url = '/app/Pacientes/OficiosPdf.aspx/GetOficioListaPacientesInternados';
                        break;
                    case "3":
                        url = '/app/Pacientes/OficiosPdf.aspx/GetListaIngresosAyer';
                        break;
                    case "4":
                        url = '/app/Pacientes/OficiosPdf.aspx/GetListaAreas';
                        break;
                }
