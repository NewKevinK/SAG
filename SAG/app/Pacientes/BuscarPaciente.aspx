<%@ Page Title="Buscar Paciente" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="BuscarPaciente.aspx.cs" Inherits="SAG.app.Pacientes.BuscarPaciente" %>
    ...
    app.controller('ConsultarController', function ($scope, $http, $timeout, $window, $location) {
        ...
        $scope.filtrarPacientes = function () {
            ...
            if ($scope.filtro.tipoPaciente == undefined) {
                ...
                try {
                    ...
                    $http({
                        method: 'POST',
                        url: '/app/Pacientes/BuscarPaciente.aspx/GetPacientesFiltro',
                        data: mydata,
        ...
        $scope.confirmarCambioEstado = function () {
            ...
            try {
                $http({
                    method: 'POST',
                    url: '/app/Pacientes/BuscarPaciente.aspx/PatchEstadoPaciente',
                    data: mydataestado,
                    headers: { 'Content-Type': 'application/json; charset=utf-8' },
                    dataType: 'json'
                }).then(function (response) {
